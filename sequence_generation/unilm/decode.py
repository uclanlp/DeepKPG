...
from sequence_generation.unilm.source.modeling_decoding import BertForSeq2SeqDecoder, BertConfig
import sequence_generation.unilm.source.s2s_loader as seq2seq_loader
from sequence_generation.unilm.source.utils import load_and_cache_examples
...
TOKENIZER_CLASSES = {
    ...
    'minilm2-bert-base': BertTokenizer,
    'minilm2-bert-large': BertTokenizer,
    'minilm2-roberta': RobertaTokenizer,
    'roberta': RobertaTokenizer,
    'unilm': UnilmTokenizer,
    'xbert': xBertTokenizer
}
...
def main():
    ...
    # if args.model_type in TOKENIZER_NAMES:
    #     args.tokenizer_name = TOKENIZER_NAMES[args.model_type]
    args.tokenizer_name = TOKENIZER_NAMES.get(args.model_type, args.tokenizer_name)
    tokenizer = TOKENIZER_CLASSES[args.model_type].from_pretrained(
        args.tokenizer_name,
        do_lower_case=args.do_lower_case, cache_dir=args.cache_dir if args.cache_dir else None
    )
    vocab = tokenizer.encoder if args.model_type == "roberta" else tokenizer.vocab
    ...
    for model_recover_path in [args.model_path.strip()]:
        ...
        to_pred = load_and_cache_examples(
            ...
            cached_features_file=None, shuffle=False, threads=args.workers
        )
            ...
            while next_i < len(input_lines):
                ...
                with torch.no_grad():
                    ...
                    for i in range(len(buf)):
                        ...
                        if args.model_type == "roberta" or (args.model_type == 'xbert' and 'news_roberta_base' in args.model_path):
